...
using System;
using UruIt.GameOfDrones.Persistence.Repository_Implementations;
using UruIt.GameOfDrones.Persistence.Repository_Interfaces;
using UruIt.GameOfDrones.Services.Services_Implementations;
...
namespace UruIt.GameOfDrones.Services.App_Start
{
	...
	public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
			...
			using (var hierarchicalLifetimeManager = new HierarchicalLifetimeManager())
			{
				container.RegisterType<IStatisticService, StatisticBusiness>(hierarchicalLifetimeManager);
			}
		}
    }
}
